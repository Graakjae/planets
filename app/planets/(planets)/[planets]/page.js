                ...
                <div key={nanoid()} className="flex justify-center">
                    <div className="lg:w-[80%] w-[100%]">
                        ...
                        <div className="lg:flex justify-between lg:mt-20 w-[100%] lg:h-[700px]">
                            <Image
                                className="w-[80%] h-[80%] mx-auto md:w-[60%] md:h-[60%] lg:w-[80%] lg:h-[80%] p-24
                                lg:p-10 lg:pr-[100px] lg:pt-[100px] object-contain"
                        ...
                        <div className="md:flex justify-between gap-5 my-10 px-6 md:px-10 lg:px-0">
                            {planet.facts.map(fact => (
                                <div
                                    key={nanoid()}
                                    className="border-slate-700 flex justify-between md:block border-[1px] w-full font-medium p-6 mt-[20px] items-center md:w-[100%]"
                                >
